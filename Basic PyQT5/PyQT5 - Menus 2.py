import sys
from PyQt5.QtWidgets import QMainWindow, QApplication, QLabel, QToolBar, QAction, QStatusBar, QCheckBox
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("PyQT5 Menus Example 2")
        ...
        # Adds a label widget to the toolbar
        toolbar.addWidget(QLabel('New Example'))

        # Adds a separator to the toolbar
        toolbar.addSeparator()

        # Adds a checkbox widget to the toolbar
        ...
        # Creates a separator horizontally
        file_menu.addSeparator()

        # Creates a submenu for the file menu called Check this!
        file_submenu = file_menu.addMenu('Check this!')
        # Adds an action to the submenu
        file_submenu.addAction(buttonAction2)
