...
# Imports plotlyexpress to make an interactive graph
...
app.layout = html.Div([
    ...
    # Builds a histogram with the x-axis representing the continent and the y-axis representing the life expectancy
